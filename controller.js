            ...
            for (var i = 0; i < json.length; i++) {
                if(formData[1].value != 'All' & formData[2].value != 'All'){
                    if(json[i].Column1 == formData[1].value & json[i].Column4 == formData[2].value){
                        var content = "<li><a href='https://nthu.primo.exlibrisgroup.com/discovery/fulldisplay?docid=alma" + json[i].Column2 + "&context=L&vid=886UST_NTHU:886UST_NTHU'>" + json[i].Column3 + "</a></li>";
                        str += content;
                        x++;
                    }else{
                        continue
